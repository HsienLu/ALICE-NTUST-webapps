...
var ConceptMapNode = function () {
    ...
    function ConceptMapNode(ConceptMapService, draw, id, originalId, filePath, label, x, y, width, height) {
        ...
        this.image = this.draw.image(this.filePath);
    ...
    _createClass(ConceptMapNode, [{
        ...
        value: function createDeleteButtonGroup() {
            ...
            // draw the +
            var deleteButtonXPath = ['M', topX, topY, 'L', bottomX, bottomY, 'M', leftX, leftY, 'L', rightX, rightY].join(' ');
        ...
        value: function setNodeMouseDown(nodeMouseDownFunction) {
            ...
            if (this.group != null) {
                isMobile ? this.group.touchstart(nodeMouseDownFunction) : this.group.mousedown(nodeMouseDownFunction);
            }
        }
        ...
        value: function setNodeMouseUp(nodeMouseUpFunction) {
            ...
            if (this.group != null) {
                isMobile ? this.group.touchend(nodeMouseUpFunction) : this.group.mouseup(nodeMouseUpFunction);
            }
        }
        ...
        value: function setConnectorMouseDown(connectorMouseDownFunction) {
            ...
            // if (this.connector != null) {
            //     isMobile ? (this.connector.touchstart(connectorMouseDownFunction)) : this.connector.mousedown(connectorMouseDownFunction);
            // }
            if (this.connector != null) {
        ...
        value: function setDeleteButtonMouseDown(deleteButtonMouseDownFunction) {
            ...
            if (this.deleteButtonCircle != null) {
                isMobile ? this.deleteButtonCircle.touchstart(deleteButtonMouseDownFunction) : this.deleteButtonCircle.mousedown(deleteButtonMouseDownFunction);
            }
        }
...
var ConceptMapLink = function () {
    ...
    function ConceptMapLink(ConceptMapService, draw, id, originalId, sourceNode, destinationNode, label, color, curvature, startCurveUp, endCurveUp) {
        ...
        if (this.curvedLink) {
            ...
            this.head = this.draw.path(arrowPathArraysObject[1].join(' '));
            this.path = this.draw.path(arrowPathArraysObject[0].join(' '));
        } else {
            // create a straight line
            this.path = this.draw.path(['M', x1, y1, 'L', x2, y2].join(' '));
        }
    ...
    _createClass(ConceptMapLink, [{
        ...
        value: function updateCoordinates(x1, y1, x2, y2, isDragging) {
            ...
            if (this.curvedLink) {
                ...
                this.head.plot(arrowPathArraysObject[1].join(' '));
                this.path.plot(arrowPathArraysObject[0].join(' '));
            } else {
                ...
                // re-plot the line
                this.path.plot(['M', x1, y1, 'L', x2, y2].join(' '));
            }
        ...
        value: function calculateCurvedLine(x1, y1, x2, y2, isDragging) {
            ...
            return this.ConceptMapService.arrowPathArrays(startx, starty, endx, endy, startCurveUp, endCurveUp, len, angle, curvature, nodeRadius);
        }
        ...
        value: function setLinkMouseDown(linkMouseDownFunction) {
            ...
            if (this.group != null) {
                 ...
                 * the function
                 */
                isMobile ? this.group.touchstart(linkMouseDownFunction) : this.group.mousedown(linkMouseDownFunction);
            }
        }
        ...
        value: function setLinkTextMouseDown(linkTextMouseDownFunction) {
            ...
            if (this.textGroup != null) {
                 ...
                 * the function
                 */
                isMobile ? this.textGroup.touchstart(linkTextMouseDownFunction) : this.textGroup.mousedown(linkTextMouseDownFunction);
            }
        }
        ...
        */
        ...
        value: function moveTextGroupToFront() {
            console.log('this.textGroup', this.textGroup)
