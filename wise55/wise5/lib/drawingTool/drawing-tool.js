(function(/*! Brunch !*/) {
  ...
  if (typeof globals.require2 === 'function') return;
  ...
  var localrequire2 = function(path) {
    return function(name) {
      var dir = dirname(path);
      var absolute = expand(dir, name);
      return globals.require2(absolute, path);
    };
  };
  ...
  var initModule = function(name, definition) {
    ...
    cache[name] = module;
    definition(module.exports, localrequire2(name), module);
    return module.exports;
  };

  var require2 = function(name, loaderPath) {
  ...
  globals.require2 = require2;
  globals.require2.define = define;
  globals.require2.register = define;
  globals.require2.list = list;
  globals.require2.brunch = true;
})();
require2.register("scripts/convert-state", function(exports, require2, module) {
var $ = jQuery;
...
require2.register("scripts/drawing-tool", function(exports, require2, module) {
var $ = jQuery;
var SelectionTool     = require2('scripts/tools/select-tool');
var LineTool          = require2('scripts/tools/shape-tools/line-tool');
var BasicShapeTool    = require2('scripts/tools/shape-tools/basic-shape-tool');
var FreeDrawTool      = require2('scripts/tools/shape-tools/free-draw');
var TextTool          = require2('scripts/tools/shape-tools/text-tool');
var StampTool         = require2('scripts/tools/shape-tools/stamp-tool');
var DeleteTool        = require2('scripts/tools/delete-tool');
var CloneTool         = require2('scripts/tools/clone-tool');
var UIManager         = require2('scripts/ui/ui-manager');
var UndoRedo          = require2('scripts/undo-redo');
...
require2.register("scripts/fabric-extensions/line-custom-control-points", function(exports, require2, module) {
var $ = jQuery;
...
require2.register("scripts/fabric-extensions/multi-touch-support", function(exports, require2, module) {
var $ = jQuery;
...
require2.register("scripts/fabric-extensions/rescale-2-resize", function(exports, require2, module) {
var $ = jQuery;
var LineTool = require2('scripts/tools/shape-tools/line-tool');
...
require2.register("scripts/inherit", function(exports, require2, module) {
var $ = jQuery;
/**
...
require2.register("scripts/jquery-longpress", function(exports, require2, module) {
var $ = jQuery;
(function ($) {
...
require2.register("scripts/tool", function(exports, require2, module) {
var $ = jQuery;
/**
 * Tool "Class"
 *
...
require2.register("scripts/tools/clone-tool", function(exports, require2, module) {
var $ = jQuery;
var inherit = require2('scripts/inherit');
var Tool    = require2('scripts/tool');
...
require2.register("scripts/tools/delete-tool", function(exports, require2, module) {
var $ = jQuery;
var inherit  = require2('scripts/inherit');
var Tool     = require2('scripts/tool');
...
require2.register("scripts/tools/select-tool", function(exports, require2, module) {
var $ = jQuery;
var inherit                 = require2('scripts/inherit');
var Tool                    = require2('scripts/tool');
var lineCustomControlPoints = require2('scripts/fabric-extensions/line-custom-control-points');
...
require2.register("scripts/tools/shape-tool", function(exports, require2, module) {
var $ = jQuery;
var inherit = require2('scripts/inherit');
var Tool    = require2('scripts/tool');
var Util    = require2('scripts/util');
...
require2.register("scripts/tools/shape-tools/basic-shape-tool", function(exports, require2, module) {
var $ = jQuery;
var inherit   = require2('scripts/inherit');
var ShapeTool = require2('scripts/tools/shape-tool');
var Util      = require2('scripts/util');
...
require2.register("scripts/tools/shape-tools/free-draw", function(exports, require2, module) {
var $ = jQuery;
var inherit   = require2('scripts/inherit');
var ShapeTool = require2('scripts/tools/shape-tool');
...
require2.register("scripts/tools/shape-tools/line-tool", function(exports, require2, module) {
var $ = jQuery;
var inherit                 = require2('scripts/inherit');
var ShapeTool               = require2('scripts/tools/shape-tool');
var SelectTool              = require2('scripts/tools/select-tool');
var Util                    = require2('scripts/util');
var lineCustomControlPoints = require2('scripts/fabric-extensions/line-custom-control-points');
require2('scripts/fabric-extensions/arrow');
...
require2.register("scripts/tools/shape-tools/stamp-tool", function(exports, require2, module) {
var $ = jQuery;
var inherit   = require2('scripts/inherit');
var ShapeTool = require2('scripts/tools/shape-tool');
...
require2.register("scripts/tools/shape-tools/text-tool", function(exports, require2, module) {
var $ = jQuery;
var inherit   = require2('scripts/inherit');
var ShapeTool = require2('scripts/tools/shape-tool');
...
require2.register("scripts/ui/basic-button", function(exports, require2, module) {
var $ = jQuery;
require2('scripts/jquery-longpress');
...
require2.register("scripts/ui/color-button", function(exports, require2, module) {
var $ = jQuery;
var inherit     = require2('scripts/inherit');
var BasicButton = require2('scripts/ui/basic-button');
...
require2.register("scripts/ui/fill-button", function(exports, require2, module) {
var $ = jQuery;
var inherit     = require2('scripts/inherit');
var BasicButton = require2('scripts/ui/basic-button');
...
require2.register("scripts/ui/generate-stamps", function(exports, require2, module) {
var $ = jQuery;
var StampImageButton = require2('scripts/ui/stamp-image-button');
...
require2.register("scripts/ui/line-width-button", function(exports, require2, module) {
var $ = jQuery;
var inherit     = require2('scripts/inherit');
var BasicButton = require2('scripts/ui/basic-button');
...
require2.register("scripts/ui/palette", function(exports, require2, module) {
var $ = jQuery;
...
require2.register("scripts/ui/stamp-image-button", function(exports, require2, module) {
var $ = jQuery;
var inherit     = require2('scripts/inherit');
var BasicButton = require2('scripts/ui/basic-button');
...
require2.register("scripts/ui/stroke-button", function(exports, require2, module) {
var $ = jQuery;
var inherit     = require2('scripts/inherit');
var BasicButton = require2('scripts/ui/basic-button');
...
require2.register("scripts/ui/ui-definition", function(exports, require2, module) {
var $ = jQuery;
var StrokeButton    = require2('scripts/ui/stroke-button');
var FillButton      = require2('scripts/ui/fill-button');
var ColorButton     = require2('scripts/ui/color-button');
var LineWidthButton = require2('scripts/ui/line-width-button');
...
require2.register("scripts/ui/ui-manager", function(exports, require2, module) {
var $ = jQuery;
var BasicButton    = require2('scripts/ui/basic-button');
var Palette        = require2('scripts/ui/palette');
var generateStamps = require2('scripts/ui/generate-stamps');
var uiDefinition   = require2('scripts/ui/ui-definition');
...
require2.register("scripts/undo-redo", function(exports, require2, module) {
var $ = jQuery;
