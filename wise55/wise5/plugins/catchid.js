...
*/	
        ...
        function showname(link) {
            ...
            link += "?loginID=" + _fullname + "&runId=" + getQueryString()+ "&userName="+ _fullname+ "&nodeId=" + getNodeString();
            console.log(link);
            return link;
        }
/* 		
...
*/            
		document.getElementById("myframe").src = showname("http://cwiselab.gise.ntnu.edu.tw/chat/api/chat_link.php");