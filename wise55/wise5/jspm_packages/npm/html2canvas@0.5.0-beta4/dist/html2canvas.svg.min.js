...
(function(Buffer) {
  !function(a) {
    if ("object" == typeof exports && "undefined" != typeof module)
      ...
      var b;
      b = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : this, (b.html2canvas || (b.html2canvas = {})).svg = a();
    }
  }(function() {
    var define,
        module,
        ...
        (function(Buffer) {
          ...
          var Cufon = function() {
            ...
            function b() {
              ...
              this.add = function(b) {
                ...
                for (var j in e)
                  j = parseInt(j, 10), (!f || f > j) && (f = j), (!g || j > g) && (g = j), i.push(j);
                return f > d && (d = f), d > g && (d = g), i.sort(function(a, b) {
                  return (h ? a > d && b > d ? b > a : a > b : d > a && d > b ? a > b : b > a) ? -1 : 1;
                }), e[i[0]];
              };
            }
            function c() {
              ...
              this.attach = function(a) {
                void 0 === a.onmouseenter ? (f(a, "mouseover", b), f(a, "mouseout", b)) : (f(a, "mouseenter", c), f(a, "mouseleave", c));
              };
            }
            function d() {
              function a(a) {
            ...
            function l(a, b, c, d, e, f) {
              var g = d.separate;
              if ("none" == g)
                return u[d.engine].apply(null, arguments);
              var h,
              ...
              for (var l = 0,
                  m = j.length; m > l; ++l)
                h = u[d.engine](a, k ? p.textAlign(j[l], c, l, m) : j[l], c, d, e, f, m - 1 > l), h && i.appendChild(h);
              return i;
            }
            function m(a, b) {
              for (var c,
                ...
                if (d || (d = p.getStyle(a).extend(b)), c || (c = i(a, d)), c)
                  if (f)
                    u[b.engine](c, null, d, b, h, a);
                  else {
                    var j = h.data;
                    if ("undefined" != typeof G_vmlCanvasManager && (j = j.replace(/\r/g, "\n")), "" !== j) {
                      var k = l(c, j, d, b, h, a);
            ...
            var n = function() {
              return n.replace.apply(null, arguments);
                ...
                o = n.DOM = {ready: function() {
                    ...
                    }(), f(fabric.window, "load", d), function(b) {
                ...
                p = n.CSS = {
                  ...
                  ready: function() {
                    var a = !1,
                        ...
                        d = Object.prototype.propertyIsEnumerable ? j("style") : {length: 0},
                        e = j("link");
                    return o.ready(function() {
                      for (var a,
                          b = 0,
                          f = 0,
                          g = e.length; a = e[f], g > f; ++f)
                        a.disabled || "stylesheet" != a.rel.toLowerCase() || ++b;
                      fabric.document.styleSheets.length >= d.length + b ? c() : setTimeout(arguments.callee, 10);
                    }), function(c) {
                      a ? c() : b.push(c);
                    };
                  }(),
                  ...
                  textAlign: function(a, b, c, d) {
                    return "right" == b.get("textAlign") ? c > 0 && (a = " " + a) : d - 1 > c && (a += " "), a;
                  },
                  textDecoration: function(a, b) {
                    ...
                    for (var c = {
                      ...
                      var e = !0;
                      for (var f in c)
                        c[f] || (-1 != b.get("textDecoration").indexOf(f) && (c[f] = b.get("color")), e = !1);
                      if (e)
                        break;
                  ...
                  textShadow: h(function(a) {
                    ...
                    for (var b,
                        ...
                        d = {},
                        e = 0,
                        f = /(#[a-f0-9]+|[a-z]+\(.*?\)|[a-z]+)|(-?[\d.]+[a-z%]*)|,/gi; b = f.exec(a); )
                      "," == b[0] ? (c.push(d), d = {}, e = 0) : b[1] ? d.color = b[1] : d[["offX", "offY", "blur"][e++]] = b[2];
                    return c.push(d), c;
                  }),
                  color: h(function(a) {
                    var b = {};
            ...
            return n.now = function() {
              ...
              var d = new a(c),
                  e = d.family;
              return v[e] || (v[e] = new b), v[e].add(d), n.set("fontFamily", '"' + e + '"');
            }, n.replace = function(a, b, c) {
              return b = k(w, b), b.engine ? ("string" == typeof b.textShadow && b.textShadow && (b.textShadow = p.textShadow(b.textShadow)), c || t.push(arguments), (a.nodeType || "string" == typeof a) && (a = [a]), p.ready(function() {
                for (var c = 0,
                    d = a.length; d > c; ++c) {
                  var e = a[c];
                  "string" == typeof e ? n.replace(b.selector(e), b, !0) : m(e, b);
                }
              }), n) : n;
            }, n.replaceElement = function(a, b) {
              return b = k(w, b), "string" == typeof b.textShadow && b.textShadow && (b.textShadow = p.textShadow(b.textShadow)), m(a, b);
            }, n.engines = u, n.fonts = v, n.getOptions = function() {
              return k(w);
            }, n.set = function(a, b) {
              return w[a] = b, n;
            }, n;
          ...
          Cufon.registerEngine("canvas", function() {
              ...
              a: for (var h = 0; c = g.exec(a); ++h) {
                ...
                switch (c[1]) {
                  case "v":
                    f[h] = {
                      m: "bezierCurveTo",
                      a: [d + ~~i[0], e + ~~i[1], d + ~~i[2], e + ~~i[3], d += ~~i[4], e += ~~i[5]]
                    };
                    break;
                  case "r":
                    f[h] = {
            ...
            var c = Cufon.CSS.supports("display", "inline-block"),
                d = !c && ("BackCompat" == fabric.document.compatMode || /frameset|transitional/i.test(fabric.document.doctype.publicId)),
            ...
            return fabric.document.getElementsByTagName("head")[0].appendChild(e), function(d, e, f, g, h, i) {
              function j() {
                U.save();
                var a = 0,
                    b = 0,
                    c = [{left: 0}];
                g.backgroundColor && (U.save(), U.fillStyle = g.backgroundColor, U.translate(0, d.ascent), U.fillRect(0, 0, B + 10, (-d.ascent + d.descent) * E), U.restore()), "right" === g.textAlign ? (U.translate(H[b], 0), c[0].left = H[b] * V) : "center" === g.textAlign && (U.translate(H[b] / 2, 0), c[0].left = H[b] / 2 * V);
                for (var e = 0,
                    f = A.length; f > e; ++e)
                  if ("\n" !== A[e]) {
                    var h = d.glyphs[A[e]] || d.missingGlyph;
                    if (h) {
                      var i = Number(h.w || d.w) + o;
                      g.textBackgroundColor && (U.save(), U.fillStyle = g.textBackgroundColor, U.translate(0, d.ascent), U.fillRect(0, 0, i + 10, -d.ascent + d.descent), U.restore()), U.translate(i, 0), a += i, e == f - 1 && (c[c.length - 1].width = a * V, c[c.length - 1].height = (-d.ascent + d.descent) * V);
                    }
                  } else {
                    b++;
                    var j = -d.ascent - d.ascent / 5 * g.lineHeight,
                        k = c[c.length - 1],
                        l = {left: 0};
                    k.width = a * V, k.height = (-d.ascent + d.descent) * V, "right" === g.textAlign ? (U.translate(-B, j), U.translate(H[b], 0), l.left = H[b] * V) : "center" === g.textAlign ? (U.translate(-a - H[b - 1] / 2, j), U.translate(H[b] / 2, 0), l.left = H[b] / 2 * V) : U.translate(-a, j), c.push(l), a = 0;
                  }
                U.restore(), Cufon.textOptions.boundaries = c;
              }
              function k(c) {
                U.fillStyle = c || Cufon.textOptions.color || f.get("color");
                var e = 0,
                    h = 0;
                "right" === g.textAlign ? U.translate(H[h], 0) : "center" === g.textAlign && U.translate(H[h] / 2, 0);
                for (var i = 0,
                    j = A.length; j > i; ++i)
                  if ("\n" !== A[i]) {
                    var k = d.glyphs[A[i]] || d.missingGlyph;
                    if (k) {
                      var l = Number(k.w || d.w) + o;
                      X && (U.save(), U.strokeStyle = U.fillStyle, U.lineWidth += U.lineWidth, U.beginPath(), X.underline && (U.moveTo(0, -d.face["underline-position"] + .5), U.lineTo(l, -d.face["underline-position"] + .5)), X.overline && (U.moveTo(0, d.ascent + .5), U.lineTo(l, d.ascent + .5)), X["line-through"] && (U.moveTo(0, -d.descent + .5), U.lineTo(l, -d.descent + .5)), U.stroke(), U.restore()), Y && (U.save(), U.transform(1, 0, -.25, 1, 0, 0)), U.beginPath(), k.d && (k.code ? b(k.code, U) : k.code = a("m" + k.d, U)), U.fill(), g.strokeStyle && (U.closePath(), U.save(), U.lineWidth = g.strokeWidth, U.strokeStyle = g.strokeStyle, U.stroke(), U.restore()), Y && U.restore(), U.translate(l, 0), e += l;
                    }
                  } else {
                    h++;
                    var m = -d.ascent - d.ascent / 5 * g.lineHeight;
                    "right" === g.textAlign ? (U.translate(-B, m), U.translate(H[h], 0)) : "center" === g.textAlign ? (U.translate(-e - H[h - 1] / 2, m), U.translate(H[h] / 2, 0)) : U.translate(-e, m), e = 0;
                  }
              }
              var l = null === e,
                  m = d.viewBox,
                  n = f.getSize("fontSize", d.baseSize),
                  o = f.get("letterSpacing");
              o = "normal" == o ? 0 : n.convertFrom(parseInt(o, 10));
              var p = 0,
                  q = 0,
                  r = 0,
                  s = 0,
                  t = g.textShadow,
                  u = [];
              if (Cufon.textOptions.shadowOffsets = [], Cufon.textOptions.shadows = null, t) {
                Cufon.textOptions.shadows = t;
                for (var v = 0,
                    w = t.length; w > v; ++v) {
                  var x = t[v],
                      y = n.convertFrom(parseFloat(x.offX)),
                      z = n.convertFrom(parseFloat(x.offY));
                  u[v] = [y, z];
                }
              }
              for (var A = Cufon.CSS.textTransform(l ? h.alt : e, f).split(""),
                  B = 0,
                  C = null,
                  D = 0,
                  E = 1,
                  ...
                  w = A.length; w > v; ++v)
                if ("\n" !== A[v]) {
                  var G = d.glyphs[A[v]] || d.missingGlyph;
                  G && (B += C = Number(G.w || d.w) + o);
                } else
                  E++, B > D && (D = B), F.push(B), B = 0;
              F.push(B), B = Math.max(D, B);
              for (var H = [],
                  v = F.length; v--; )
                H[v] = B - F[v];
              if (null === C)
                return null;
              q += m.width - C, s += m.minX;
              var I,
                  J;
              if (l)
                I = h, J = h.firstChild;
              else if (I = fabric.document.createElement("span"), I.className = "cufon cufon-canvas", I.alt = e, J = fabric.document.createElement("canvas"), I.appendChild(J), g.printable) {
                var K = fabric.document.createElement("span");
                K.className = "cufon-alt", K.appendChild(fabric.document.createTextNode(e)), I.appendChild(K);
              }
              var L = I.style,
                  M = J.style || {},
                  N = n.convert(m.height - p + r),
                  O = Math.ceil(N),
                  P = O / N;
              J.width = Math.ceil(n.convert(B + q - s) * P), J.height = O, p += m.minY, M.top = Math.round(n.convert(p - d.ascent)) + "px", M.left = Math.round(n.convert(s)) + "px";
              var Q = Math.ceil(n.convert(B * P)),
                  R = Q + "px",
                  S = n.convert(d.height),
                  T = (g.lineHeight - 1) * n.convert(-d.ascent / 5) * (E - 1);
              Cufon.textOptions.width = Q, Cufon.textOptions.height = S * E + T, Cufon.textOptions.lines = E, Cufon.textOptions.totalLineHeight = T, c ? (L.width = R, L.height = S + "px") : (L.paddingLeft = R, L.paddingBottom = S - 1 + "px");
              var U = Cufon.textOptions.context || J.getContext("2d"),
                  V = O / m.height;
              Cufon.textOptions.fontAscent = d.ascent * V, Cufon.textOptions.boundaries = null;
              for (var W = Cufon.textOptions.shadowOffsets,
                  v = u.length; v--; )
                W[v] = [u[v][0] * V, u[v][1] * V];
              U.save(), U.scale(V, V), U.translate(-s - 1 / V * J.width / 2 + (Cufon.fonts[d.family].offsetLeft || 0), -p - Cufon.textOptions.height / V / 2 + (Cufon.fonts[d.family].offsetTop || 0)), U.lineWidth = d.face["underline-thickness"], U.save();
              var X = Cufon.getTextDecoration(g),
                  Y = "italic" === g.fontStyle;
              if (U.save(), j(), t)
                for (var v = 0,
                    w = t.length; w > v; ++v) {
                  var x = t[v];
                  U.save(), U.translate.apply(U, u[v]), k(x.color), U.restore();
                }
              return k(), U.restore(), U.restore(), U.restore(), I;
            };
            ...
            if (fabric.document.namespaces) {
              ...
              if (!(c && c.getContext && c.getContext.apply)) {
                ...
                if (d.style.behavior = "url(#default#VML)", d.coordsize)
                  return d = null, fabric.document.write('<style type="text/css">.cufon-vml-canvas{text-indent:0}@media screen{cvml\\:shape,cvml\\:shadow{behavior:url(#default#VML);display:block;antialias:true;position:absolute}.cufon-vml-canvas{position:absolute;text-align:left}.cufon-vml{display:inline-block;position:relative;vertical-align:middle}.cufon-vml .cufon-alt{position:absolute;left:-10000in;font-size:1px}a .cufon-vml{cursor:pointer}}@media print{.cufon-vml *{display:none}.cufon-vml .cufon-alt{display:inline}}</style>'), function(c, d, e, f, g, h, i) {
                    var j = null === d;
                    j && (d = g.alt);
                    var k = c.viewBox,
                        l = e.computedFontSize || (e.computedFontSize = new Cufon.CSS.Size(a(h, e.get("fontSize")) + "px", c.baseSize)),
                        m = e.computedLSpacing;
                    void 0 == m && (m = e.get("letterSpacing"), e.computedLSpacing = m = "normal" == m ? 0 : ~~l.convertFrom(b(h, m)));
                    var n,
                        o;
                    if (j)
                      n = g, o = g.firstChild;
                    else {
                      if (n = fabric.document.createElement("span"), n.className = "cufon cufon-vml", n.alt = d, o = fabric.document.createElement("span"), o.className = "cufon-vml-canvas", n.appendChild(o), f.printable) {
                        var p = fabric.document.createElement("span");
                        p.className = "cufon-alt", p.appendChild(fabric.document.createTextNode(d)), n.appendChild(p);
                      }
                    ...
                    var q = n.style,
                        ...
                        v = k.minX,
                        w = k.minY;
                    r.height = t, r.top = Math.round(l.convert(w - c.ascent)), r.left = Math.round(l.convert(v)), q.height = l.convert(c.height) + "px";
                    for (var x,
                        y,
                        ...
                        G = 0,
                        H = A.length; H > F; ++F)
                      x = c.glyphs[A[F]] || c.missingGlyph, x && (B += D = ~~(x.w || c.w) + m);
                    if (null === D)
                      return null;
                    var I,
                        J = -v + B + (k.width - D),
                    ...
                    for (F = 0; H > F; ++F)
                      if (x = c.glyphs[A[F]] || c.missingGlyph) {
                        j ? (y = o.childNodes[G], y.firstChild && y.removeChild(y.firstChild)) : (y = fabric.document.createElement("cvml:shape"), o.appendChild(y)), y.stroked = "f", y.coordsize = M, y.coordorigin = I = v - C + "," + w, y.path = (x.d ? "m" + x.d + "xe" : "") + "m" + I + N, y.fillcolor = z;
                        var O = y.style;
                        if (O.width = L, O.height = t, E) {
                          ...
                          T.on = "t", T.color = S.color, T.offset = Q.offX + "," + Q.offY, R && (P = Cufon.CSS.color(R.color), T.type = "double", T.color2 = P.color, T.offset2 = R.offX + "," + R.offY), T.opacity = S.opacity || P && P.opacity || 1, y.appendChild(T);
                        }
                        C += ~~(x.w || c.w) + m, ++G;
                      }
            ...
            function b(a, b) {
              if (this.__eventListeners || (this.__eventListeners = {}), 1 === arguments.length)
                ...
                this.__eventListeners[a] || (this.__eventListeners[a] = []), this.__eventListeners[a].push(b);
              return this;
            }
            function c(b, c) {
            ...
            remove: function() {
              for (var a,
                  ...
                  c = 0,
                  d = arguments.length; d > c; c++)
                a = b.indexOf(arguments[c]), -1 !== a && (b.splice(a, 1), this._onObjectRemoved(arguments[c]));
              return this.renderOnAddRemove && this.renderAll(), this;
            },
            forEachObject: function(a, b) {
              for (var c = this.getObjects(),
                  d = c.length; d--; )
                a.call(b, c[d], d, c);
              return this;
            },
            ...
            fabric.util = {
              ...
              drawDashedLine: function(a, d, e, f, g, h) {
                var i = f - d,
                    ...
                    n = 0,
                    o = !0;
                for (a.save(), a.translate(d, e), a.moveTo(0, 0), a.rotate(l), d = 0; k > d; )
                  d += h[n++ % m], d > k && (d = k), a[o ? "lineTo" : "moveTo"](d, 0), o = !o;
                a.restore();
              },
              ...
              createAccessors: function(a) {
                for (var b = a.prototype,
                    c = b.stateProperties.length; c--; ) {
              ...
              multiplyTransformMatrices: function(a, b) {
                for (var c = [[a[0], a[2], a[4]], [a[1], a[3], a[5]], [0, 0, 1]],
                    d = [[b[0], b[2], b[4]], [b[1], b[3], b[5]], [0, 0, 1]],
                    e = [],
                    f = 0; 3 > f; f++) {
                  e[f] = [];
                  for (var g = 0; 3 > g; g++) {
              ...
              isTransparent: function(a, b, c, d) {
                ...
                for (var e = !0,
                    f = a.getImageData(b, c, 2 * d || 1, 2 * d || 1),
                    g = 3,
                    h = f.data.length; h > g; g += 4) {
                  var i = f.data[g];
                  if (e = 0 >= i, e === !1)
                    break;
                }
            ...
            function a(a, e, g, h, i, j, k) {
              ...
              var B = z * g * t / h,
                  ...
                  E = o * B + p * C + e / 2,
                  F = c(1, 0, (s - B) / g, (t - C) / h),
                  G = c((s - B) / g, (t - C) / h, (-s - B) / g, (-t - C) / h);
              0 === j && G > 0 ? G -= 2 * m : 1 === j && 0 > G && (G += 2 * m);
              for (var H = Math.ceil(Math.abs(G / (.5 * m))),
                  I = [],
                  J = G / H,
                  K = 8 / 3 * Math.sin(J / 4) * Math.sin(J / 4) / Math.sin(J / 2),
                  L = F + J,
                  M = 0; H > M; M++)
                I[M] = b(F, L, p, o, g, h, D, E, K, q, r), q = I[M][4], r = I[M][5], F += J, L += J;
              return d[l] = I, I;
            }
            function b(a, b, c, d, g, h, i, j, k, l, m) {
            ...
            fabric.util.drawArc = function(b, c, d, e) {
              for (var f = e[0],
                  ...
                  l = e[6],
                  m = [[], [], [], []],
                  n = a(k - c, l - d, f, g, i, j, h),
                  o = 0,
                  p = n.length; p > o; o++)
                m[o][0] = n[o][0] + c, m[o][1] = n[o][1] + d, m[o][2] = n[o][2] + c, m[o][3] = n[o][3] + d, m[o][4] = n[o][4] + c, m[o][5] = n[o][5] + d, b.bezierCurveTo.apply(b, m[o]);
            };
          }(), function() {
            function a(a, b) {
              for (var c = e.call(arguments, 2),
                  d = [],
                  f = 0,
                  g = a.length; g > f; f++)
                d[f] = c.length ? a[f][b].apply(a[f], c) : a[f][b].call(a[f]);
              return d;
            }
            function b(a, b) {
            ...
            function e(a, b) {
              ...
              var c = a.target || (typeof a.srcElement !== i ? a.srcElement : null),
                  d = fabric.util.getScrollLeftTop(c, b);
              return {
                x: q(a) + d.left,
                y: r(a) + d.top
              };
            ...
            var k,
                l,
                m = a(fabric.document.documentElement, "addEventListener", "removeEventListener") && a(fabric.window, "addEventListener", "removeEventListener"),
            ...
            m ? (k = function(a, b, c) {
              ...
              if (o[e] && o[e][b])
                for (var f = 0,
                    g = o[e][b].length; g > f; f++)
                  d = o[e][b][f], d && d.handler === c && (a.detachEvent("on" + b, d.wrappedHandler), o[e][b][f] = null);
            }) : (k = function(a, b, c) {
              var e = j(a);
              if (p[e] || (p[e] = {}), !p[e][b]) {
                p[e][b] = [];
            ...
            function a(a, b) {
              ...
              if (!c)
                return a;
              if ("string" == typeof b)
                return a.style.cssText += ";" + b, b.indexOf("opacity") > -1 ? f(a, b.match(/opacity:\s*(\d?\.?\d*)/)[1]) : a;
              for (var d in b)
                if ("opacity" === d)
                  f(a, b[d]);
                else {
            ...
            function e(a, b) {
              var c,
                  ...
                  e = 0,
                  f = 0,
                  g = fabric.document.documentElement,
                  h = fabric.document.body || {
                    scrollLeft: 0,
                    scrollTop: 0
                  };
              for (d = a; a && a.parentNode && !c; )
                a = a.parentNode, a !== fabric.document && "fixed" === fabric.util.getElementStyle(a, "position") && (c = a), a !== fabric.document && d !== b && "absolute" === fabric.util.getElementStyle(a, "position") ? (e = 0, f = 0) : a === fabric.document ? (e = h.scrollLeft || g.scrollLeft || 0, f = h.scrollTop || g.scrollTop || 0) : (e += a.scrollLeft || 0, f += a.scrollTop || 0);
              return {
                left: e,
                top: f
              };
            ...
            function f(a) {
              ...
              for (var h in g)
                f[g[h]] += parseInt(k(a, h), 10) || 0;
              return b = d.documentElement, "undefined" != typeof a.getBoundingClientRect && (e = a.getBoundingClientRect()), c = fabric.util.getScrollLeftTop(a, null), {
                left: e.left + c.left - (b.clientLeft || 0) + f.left,
                top: e.top + c.top - (b.clientTop || 0) + f.top
              };
            }
            var g,
            ...
            function c(a, b, c) {
              var d,
                  e = "[object Array]" === Object.prototype.toString.call(b);
              return "fill" !== a && "stroke" !== a || "none" !== b ? "fillRule" === a ? b = "evenodd" === b ? "destination-over" : b : "strokeDashArray" === a ? b = b.replace(/,/g, " ").split(/\s+/).map(function(a) {
                return parseInt(a);
              }) : "transformMatrix" === a ? b = c && c.transformMatrix ? v(c.transformMatrix, p.parseTransformAttribute(b)) : p.parseTransformAttribute(b) : "visible" === a ? (b = "none" === b || "hidden" === b ? !1 : !0, c && c.visible === !1 && (b = !1)) : "originX" === a ? b = "start" === b ? "left" : "end" === b ? "right" : "center" : d = e ? b.map(u) : u(b) : b = "", !e && isNaN(d) ? b : d;
            }
            function d(a) {
              for (var b in x)
                if (a[b] && "undefined" != typeof a[x[b]] && 0 !== a[b].indexOf("url(")) {
                  var c = new p.Color(a[b]);
                  a[b] = c.setAlpha(t(c.getAlpha() * a[x[b]], 2)).toRgba();
                }
              return a;
            }
            function e(a, b) {
            ...
            function f(a, d) {
              ...
              a.replace(/;$/, "").split(";").forEach(function(a) {
                var h = a.split(":");
                f = b(h[0].trim().toLowerCase()), g = c(f, h[1].trim()), "font" === f ? e(g, d) : d[f] = g;
              });
            }
            function g(a, d) {
              var f,
                  g;
              for (var h in a)
                "undefined" != typeof a[h] && (f = b(h.toLowerCase()), g = c(f, a[h]), "font" === f ? e(g, d) : d[f] = g);
            }
            function h(a) {
              var b = {};
              for (var c in p.cssRules)
                if (i(a, c.split(" ")))
                  for (var d in p.cssRules[c])
                    b[d] = p.cssRules[c][d];
              return b;
            }
            function i(a, b) {
              var c,
                  d = !0;
              return c = k(a, b.pop()), c && b.length && (d = j(a, b)), c && d && 0 === b.length;
            }
            function j(a, b) {
              for (var c,
                  d = !0; a.parentNode && 1 === a.parentNode.nodeType && b.length; )
                d && (c = b.pop()), a = a.parentNode, d = k(a, c);
              return 0 === b.length;
            }
            function k(a, b) {
              var c,
              ...
              if (c = new RegExp("^" + d, "i"), b = b.replace(c, ""), f && b.length && (c = new RegExp("#" + f + "(?![a-zA-Z\\-]+)", "i"), b = b.replace(c, "")), e && b.length) {
                ...
                for (var g = e.length; g--; )
                  c = new RegExp("\\." + e[g] + "(?![a-zA-Z\\-]+)", "i"), b = b.replace(c, "");
              }
              return 0 === b.length;
            }
            function l(a) {
              for (var b = a.getElementsByTagName("use"); b.length; ) {
                for (var c,
                    d = b[0],
                    e = d.getAttribute("xlink:href").substr(1),
                    f = d.getAttribute("x") || 0,
                    g = d.getAttribute("y") || 0,
                    h = a.getElementById(e).cloneNode(!0),
                    i = (d.getAttribute("transform") || "") + " translate(" + f + ", " + g + ")",
                    j = 0,
                    k = d.attributes,
                    l = k.length; l > j; j++) {
                  var m = k.item(j);
                  "x" !== m.nodeName && "y" !== m.nodeName && "xlink:href" !== m.nodeName && ("transform" === m.nodeName ? i = i + " " + m.nodeValue : h.setAttribute(m.nodeName, m.nodeValue));
                }
                h.setAttribute("transform", i), h.removeAttribute("id"), c = d.parentNode, c.replaceChild(h, d);
              }
            }
            function m(a, b) {
            ...
            p.parseTransformAttribute = function() {
              ...
              return function(g) {
                ...
                for (var j = i[0]; i.length > 1; )
                  i.shift(), j = p.util.multiplyTransformMatrices(j, i[0]);
                return j;
              };
              ...
              return function(c, e, f) {
                if (c) {
                  ...
                  var h,
                      i,
                      j = c.getAttribute("viewBox"),
                      k = u(c.getAttribute("width") || "100%"),
                      n = u(c.getAttribute("height") || "100%");
                  if (j && (j = j.match(d))) {
                    var o = parseFloat(j[1]),
                        q = parseFloat(j[2]),
                        r = 1,
                        t = 1;
                    h = parseFloat(j[3]), i = parseFloat(j[4]), k && k !== h && (r = k / h), n && n !== i && (t = n / i), m(c, [r, 0, 0, t, r * -o, t * -q]);
                  }
                  var v = p.util.toArray(c.getElementsByTagName("*"));
                  if (0 === v.length && p.isLikelyNode) {
                    v = c.selectNodes('//*[name(.)!="svg"]');
                    for (var w = [],
                        x = 0,
                        y = v.length; y > x; x++)
                      w[x] = v[x];
                  ...
                  p.gradientDefs = p.getGradientDefs(c), p.cssRules = p.getCSSRules(c), p.parseElements(z, function(a) {
                    p.documentParsingTime = new Date - g, e && e(a, A);
                  }, s(A), f);
                }
              };
            }();
            ...
            q(p, {
              getGradientDefs: function(a) {
                var b,
                    ...
                    d,
                    e,
                    f = a.getElementsByTagName("linearGradient"),
                    g = a.getElementsByTagName("radialGradient"),
                    h = 0,
                    i = [],
                    j = {},
                    k = {};
                for (i.length = f.length + g.length, c = f.length; c--; )
                  i[h++] = f[c];
                for (c = g.length; c--; )
                  i[h++] = g[c];
                for (; h--; )
                  b = i[h], e = b.getAttribute("xlink:href"), d = b.getAttribute("id"), e && (k[d] = e.substr(1)), j[d] = b;
                for (d in k) {
                  var l = j[k[d]].cloneNode(!0);
                  for (b = j[d]; l.firstChild; )
                    b.appendChild(l.firstChild);
                }
                return j;
              },
              parseAttributes: function(a, e) {
                if (a) {
                  var f,
                      g = {};
                  a.parentNode && /^symbol|[g|a]$/i.test(a.parentNode.nodeName) && (g = p.parseAttributes(a.parentNode, e));
                  var i = e.reduce(function(d, e) {
                    return f = a.getAttribute(e), f && (e = b(e), f = c(e, f, g), d[e] = f), d;
                  }, {});
                  return i = q(i, q(h(a), p.parseStyleAttribute(a))), d(q(g, i));
                }
              },
              ...
              parseStyleAttribute: function(a) {
                ...
                return c ? ("string" == typeof c ? f(c, b) : g(c, b), b) : b;
              },
              ...
              getCSSRules: function(a) {
                for (var d,
                    e = a.getElementsByTagName("style"),
                    f = {},
                    g = 0,
                    h = e.length; h > g; g++) {
                  var i = e[0].textContent;
                  i = i.replace(/\/\*[\s\S]*?\*\//g, ""), d = i.match(/[^{]*\{[\s\S]*?\}/g), d = d.map(function(a) {
                    return a.trim();
                  }), d.forEach(function(a) {
                    for (var d = a.match(/([\s\S]*?)\s*\{([^}]*)\}/),
                        e = {},
                        g = d[2].trim(),
                        h = g.replace(/;$/, "").split(/\s*;\s*/),
                        i = 0,
                        j = h.length; j > i; i++) {
                      var k = h[i].split(/\s*:\s*/),
                          l = b(k[0]),
                    ...
                    a = d[1], a.split(",").forEach(function(a) {
                      f[a.trim()] = p.util.object.clone(e);
                    });
                  });
                }
                return f;
              ...
              loadSVGFromURL: function(a, b, c) {
                ...
                a = a.replace(/^\n\s*/, "").trim(), y.has(a, function(c) {
                  c ? y.get(a, function(a) {
                    var c = n(a);
              ...
              loadSVGFromString: function(a, b, c) {
                ...
                if ("undefined" != typeof DOMParser) {
                  ...
                  p.window.ActiveXObject && (d = new ActiveXObject("Microsoft.XMLDOM"), d.async = "false", d.loadXML(a.replace(/<!DOCTYPE[\s\S]*?(\[[\s\S]*\])*?>/i, "")));
            ...
            function d(a, b, c) {
              var d,
                  ...
                  g = "";
              for (var h in b)
                d = parseFloat(b[h], 10), f = "string" == typeof b[h] && /^\d+%$/.test(b[h]) ? .01 : 1, "x1" === h || "x2" === h || "r2" === h ? (f *= "objectBoundingBox" === c ? a.width : 1, e = "objectBoundingBox" === c ? a.left || 0 : 0) : ("y1" === h || "y2" === h) && (f *= "objectBoundingBox" === c ? a.height : 1, e = "objectBoundingBox" === c ? a.top || 0 : 0), b[h] = d * f + e;
            ...
            fabric.Gradient = fabric.util.createClass({
              ...
              toSVG: function(a) {
                var b,
                    c,
                    d = fabric.util.object.clone(this.coords);
                if (this.colorStops.sort(function(a, b) {
                  return a.offset - b.offset;
                }), !a.group || "path-group" !== a.group.type)
                  for (var e in d)
                    "x1" === e || "x2" === e || "r2" === e ? d[e] += this.offsetX - a.width / 2 : ("y1" === e || "y2" === e) && (d[e] += this.offsetY - a.height / 2);
                ...
                for (var f = 0; f < this.colorStops.length; f++)
                  b.push("<stop ", 'offset="', 100 * this.colorStops[f].offset + "%", '" style="stop-color:', this.colorStops[f].color, null != this.colorStops[f].opacity ? ";stop-opacity: " + this.colorStops[f].opacity : ";", '"/>\n');
              ...
              toLive: function(a) {
                ...
                if (this.type) {
                  ...
                  for (var c = 0,
                      d = this.colorStops.length; d > c; c++) {
            ...
            fabric.StaticCanvas = fabric.util.createClass({
              ...
              _createCanvasElement: function() {
                ...
                if (a.style || (a.style = {}), !a)
                  throw d;
                return this._initCanvasElement(a), a;
              },
              _initCanvasElement: function(a) {
                if (fabric.util.createCanvasElement(a), "undefined" == typeof a.getContext)
                  throw d;
              },
              ...
              setDimensions: function(a, b) {
                ...
                b = b || {};
                for (var d in a)
                  c = a[d], b.cssOnly || (this._setBackstoreDimension(d, a[d]), c += "px"), b.backstoreOnly || this._setCssDimension(d, c);
              ...
              _renderObjects: function(a, b) {
                var c,
                    d;
                if (b)
                  for (c = 0, d = this._objects.length; d > c; ++c)
            ...
            onMouseUp: function() {
              ...
              for (var b = [],
                  c = 0,
                  d = this.sprayChunks.length; d > c; c++)
                for (var e = this.sprayChunks[c],
                    f = 0,
                    g = e.length; g > f; f++) {
            ...
            _getOptimizedRects: function(a) {
              for (var b,
                  ...
                  d = 0,
                  e = a.length; e > d; d++)
                b = a[d].left + "" + a[d].top, c[b] || (c[b] = a[d]);
              var f = [];
              for (b in c)
                f.push(c[b]);
              return f;
            ...
            render: function() {
              ...
              for (var c = 0,
                  d = this.sprayChunkPoints.length; d > c; c++) {
            ...
            b.Object || (b.Object = b.util.createClass({
              ...
              _set: function(a, c) {
                ...
                return e && (c = this._constrainScale(c)), "scaleX" === a && 0 > c ? (this.flipX = !this.flipX, c *= -1) : "scaleY" === a && 0 > c ? (this.flipY = !this.flipY, c *= -1) : "width" === a || "height" === a ? this.minScaleLimit = d(Math.min(.1, 1 / Math.max(this.width, this.height)), 2) : "shadow" !== a || !c || c instanceof b.Shadow || (c = new b.Shadow(c)), this[a] = c, this;
              },
              toggle: function(a) {
                var b = this.get(a);
              ...
              _renderStroke: function(a) {
                if (this.stroke && 0 !== this.strokeWidth) {
                  if (a.save(), this.strokeDashArray)
                    1 & this.strokeDashArray.length && this.strokeDashArray.push.apply(this.strokeDashArray, this.strokeDashArray), g ? (a.setLineDash(this.strokeDashArray), this._stroke && this._stroke(a)) : this._renderDashedStroke && this._renderDashedStroke(a), a.stroke();
                  else {
            ...
            fabric.util.object.extend(fabric.Object.prototype, {
              ...
              toLocalPoint: function(b, c, d) {
                var e,
                    ...
                    h = this.stroke ? this.strokeWidth : 0;
                return c && d ? (e = "left" === c ? g.x - (this.getWidth() + h * this.scaleX) / 2 : "right" === c ? g.x + (this.getWidth() + h * this.scaleX) / 2 : g.x, f = "top" === d ? g.y - (this.getHeight() + h * this.scaleY) / 2 : "bottom" === d ? g.y + (this.getHeight() + h * this.scaleY) / 2 : g.y) : (e = this.left, f = this.top), fabric.util.rotatePoint(new fabric.Point(b.x, b.y), g, -a(this.angle)).subtractEquals(new fabric.Point(e, f));
              },
            ...
            fabric.util.object.extend(fabric.Object.prototype, {
              ...
              _findCrossPoints: function(a, b) {
                var c,
                    ...
                    j = 0;
                for (var k in b)
                  if (i = b[k], !(i.o.y < a.y && i.d.y < a.y || i.o.y >= a.y && i.d.y >= a.y || (i.o.x === i.d.x && i.o.x >= a.x ? (g = i.o.x, h = a.y) : (c = 0, d = (i.d.y - i.o.y) / (i.d.x - i.o.x), e = a.y - c * a.x, f = i.o.y - d * i.o.x, g = -(e - f) / (c - d), h = e + c * g), g >= a.x && (j += 1), 2 !== j)))
                    break;
                return j;
              },
              ...
              _constrainScale: function(a) {
                return Math.abs(a) < this.minScaleLimit ? 0 > a ? -this.minScaleLimit : this.minScaleLimit : a;
              },
              scale: function(a) {
            ...
            return c.Line ? void c.warn("fabric.Line is already defined") : (c.Line = c.util.createClass(c.Object, {
              ...
              _set: function(a, b) {
                return this[a] = b, "undefined" != typeof e[a] && this._setWidthHeight(), this;
              },
              _getLeftToOriginX: b({
                origin: "originX",
                axis1: "x1",
              ...
              _render: function(a, b) {
                ...
                if (!this.strokeDashArray || this.strokeDashArray && f) {
                  ...
                  a.moveTo(1 === this.width ? 0 : d * this.width / 2, 1 === this.height ? 0 : e * this.height / 2), a.lineTo(1 === this.width ? 0 : -1 * d * this.width / 2, 1 === this.height ? 0 : -1 * e * this.height / 2);
                }
              ...
              _renderDashedStroke: function(a) {
                var b = this.x1 <= this.x2 ? -1 : 1,
                    d = this.y1 <= this.y2 ? -1 : 1,
                    e = 1 === this.width ? 0 : b * this.width / 2,
                    f = 1 === this.height ? 0 : d * this.height / 2;
                a.beginPath(), c.util.drawDashedLine(a, e, f, -e, -f, this.strokeDashArray), a.closePath();
              },
              toObject: function(a) {
            ...
            return c.Circle ? void c.warn("fabric.Circle is already defined.") : (c.Circle = c.util.createClass(c.Object, {
              ...
              toObject: function(a) {
                return e(this.callSuper("toObject", a), {radius: this.get("radius")});
              },
              toSVG: function(a) {
                var b = this._createBaseSVGMarkup(),
                    c = 0,
              ...
              _render: function(a, b) {
                a.beginPath(), a.arc(b ? this.left + this.radius : 0, b ? this.top + this.radius : 0, this.radius, 0, d, !1), this._renderFill(a), this._renderStroke(a);
              },
              getRadiusX: function() {
            ...
            return b.Polyline ? void b.warn("fabric.Polyline is already defined") : (b.Polyline = b.util.createClass(b.Object, {
              ...
              toSVG: function(a) {
                for (var b = [],
                    d = this._createBaseSVGMarkup(),
                    e = 0,
                    f = this.points.length; f > e; e++)
              ...
              _renderDashedStroke: function(a) {
                ...
                for (var e = 0,
                    f = this.points.length; f > e; e++)
                  c = this.points[e], d = this.points[e + 1] || c, b.util.drawDashedLine(a, c.x, c.y, d.x, d.y, this.strokeDashArray);
              },
              complexity: function() {
            ...
            return b.Polygon ? void b.warn("fabric.Polygon is already defined") : (b.Polygon = b.util.createClass(b.Object, {
              ...
              toSVG: function(a) {
                for (var b = [],
                    c = this._createBaseSVGMarkup(),
                    d = 0,
                    e = this.points.length; e > d; d++)
              ...
              _renderDashedStroke: function(a) {
                ...
                for (var e = 0,
                    f = this.points.length; f > e; e++)
                  c = this.points[e], d = this.points[e + 1] || this.points[0], b.util.drawDashedLine(a, c.x, c.y, d.x, d.y, this.strokeDashArray);
                a.closePath();
              },
              complexity: function() {
            ...
            return d.Path ? void d.warn("fabric.Path is already defined") : (d.Path = d.util.createClass(d.Object, {
              type: "path",
              path: null,
              initialize: function(a, b) {
                if (b = b || {}, this.setOptions(b), !a)
                  throw new Error("`path` argument is required");
                var c = "[object Array]" === h.call(a);
              ...
              _initializePath: function(a) {
                var b = "width" in a && null != a.width,
                    ...
                    f = d ? this.left : 0,
                    h = e ? this.top : 0;
                b && c ? (e || (this.top = this.height / 2), d || (this.left = this.width / 2)) : (g(this, this._parseDimensions()), b && (this.width = a.width), c && (this.height = a.height)), this.pathOffset = this.pathOffset || this._calculatePathOffset(f, h);
              },
              ...
              _render: function(a, b) {
                var c,
                    ...
                    n = 0,
                    o = 0,
                    p = -(this.width / 2 + this.pathOffset.x),
                    q = -(this.height / 2 + this.pathOffset.y);
                b && (p += this.width / 2, q += this.height / 2);
                for (var r = 0,
                    s = this.path.length; s > r; ++r) {
                  switch (c = this.path[r], c[0]) {
                    case "l":
                      l += c[1], m += c[2], a.lineTo(l + p, m + q);
                      break;
                    case "L":
                      l = c[1], m = c[2], a.lineTo(l + p, m + q);
                      break;
                    case "h":
                      l += c[1], a.lineTo(l + p, m + q);
                      break;
                    case "H":
                      l = c[1], a.lineTo(l + p, m + q);
                      break;
                    case "v":
                      m += c[1], a.lineTo(l + p, m + q);
                      break;
                    case "V":
                      m = c[1], a.lineTo(l + p, m + q);
                      break;
                    case "m":
                      l += c[1], m += c[2], j = l, k = m, a.moveTo(l + p, m + q);
                      break;
                    case "M":
                      l = c[1], m = c[2], j = l, k = m, a.moveTo(l + p, m + q);
                      break;
                    case "c":
                      d = l + c[5], e = m + c[6], n = l + c[3], o = m + c[4], a.bezierCurveTo(l + c[1] + p, m + c[2] + q, n + p, o + q, d + p, e + q), l = d, m = e;
                      break;
                    case "C":
                      l = c[5], m = c[6], n = c[3], o = c[4], a.bezierCurveTo(c[1] + p, c[2] + q, n + p, o + q, l + p, m + q);
                      break;
                    case "s":
                      d = l + c[3], e = m + c[4], n = n ? 2 * l - n : l, o = o ? 2 * m - o : m, a.bezierCurveTo(n + p, o + q, l + c[1] + p, m + c[2] + q, d + p, e + q), n = l + c[1], o = m + c[2], l = d, m = e;
                      break;
                    case "S":
                      d = c[3], e = c[4], n = 2 * l - n, o = 2 * m - o, a.bezierCurveTo(n + p, o + q, c[1] + p, c[2] + q, d + p, e + q), l = d, m = e, n = c[1], o = c[2];
                      break;
                    case "q":
                      d = l + c[3], e = m + c[4], n = l + c[1], o = m + c[2], a.quadraticCurveTo(n + p, o + q, d + p, e + q), l = d, m = e;
                      break;
                    case "Q":
                      d = c[3], e = c[4], a.quadraticCurveTo(c[1] + p, c[2] + q, d + p, e + q), l = d, m = e, n = c[1], o = c[2];
                      break;
                    case "t":
                      d = l + c[1], e = m + c[2], null === h[0].match(/[QqTt]/) ? (n = l, o = m) : "t" === h[0] ? (n = 2 * l - f, o = 2 * m - g) : "q" === h[0] && (n = 2 * l - n, o = 2 * m - o), f = n, g = o, a.quadraticCurveTo(n + p, o + q, d + p, e + q), l = d, m = e, n = l + c[1], o = m + c[2];
                      break;
                    case "T":
                      d = c[1], e = c[2], n = 2 * l - n, o = 2 * m - o, a.quadraticCurveTo(n + p, o + q, d + p, e + q), l = d, m = e;
                      break;
                    case "a":
                      i(a, l + p, m + q, [c[1], c[2], c[3], c[4], c[5], c[6] + l + p, c[7] + m + q]), l += c[6], m += c[7];
                      break;
                    case "A":
                      i(a, l + p, m + q, [c[1], c[2], c[3], c[4], c[5], c[6] + p, c[7] + q]), l = c[6], m = c[7];
                      break;
                    case "z":
                    case "Z":
                      l = j, m = k, a.closePath();
              ...
              render: function(a, b) {
                if (this.visible) {
                  a.save(), b && a.translate(-this.width / 2, -this.height / 2);
                  var c = this.transformMatrix;
              ...
              toObject: function(a) {
                var b = g(this.callSuper("toObject", a), {
              ...
              _parsePath: function() {
                for (var a,
                    ...
                    h = /([-+]?((\d+\.\d+)|((\d+)|(\.\d+)))(?:e[-+]?\d+)?)/gi,
                    i = 0,
                    l = this.path.length; l > i; i++) {
                  for (a = this.path[i], d = a.slice(1).trim(), g.length = 0; c = h.exec(d); )
                    g.push(c[0]);
                  e = [a.charAt(0)];
                  for (var m = 0,
                      n = g.length; n > m; m++)
                    b = parseFloat(g[m]), isNaN(b) || e.push(b);
                  var o = e[0],
                      p = j[o.toLowerCase()],
                      q = k[o] || o;
                  if (e.length - 1 > p)
                    for (var r = 1,
                        s = e.length; s > r; r += p)
                      f.push([o].concat(e.slice(r, r + p))), o = q;
                  else
                    f.push(e);
                }
                return f;
              ...
              _parseDimensions: function() {
                var a = [],
                    b = [],
                    c = {};
                this.path.forEach(function(d, e) {
                  this._getCoordsFromCommand(d, e, a, b, c);
                }, this);
                var d = e(a),
                    g = e(b),
                    h = f(a),
              ...
              _getCoordsFromCommand: function(a, d, e, f, g) {
                var h = !1;
                "H" !== a[0] && (g.x = b(0 === d ? a : this.path[d - 1])), "V" !== a[0] && (g.y = c(0 === d ? a : this.path[d - 1])), a[0] === a[0].toLowerCase() && (h = !0);
                var i,
                    j = this._getXY(a, h, g);
                i = parseInt(j.x, 10), isNaN(i) || e.push(i), i = parseInt(j.y, 10), isNaN(i) || f.push(i);
              },
              _getXY: function(a, d, e) {
                var f = d ? e.x + b(a) : "V" === a[0] ? e.x : b(a),
                    g = d ? e.y + c(a) : "H" === a[0] ? e.y : c(a);
                return {
                  x: f,
                  y: g
                };
              }
            }), d.Path.fromObject = function(a, b) {
              "string" == typeof a.path ? d.loadSVGFromURL(a.path, function(c) {
                var e = c[0],
                    f = a.path;
                delete a.path, d.util.object.extend(e, a), e.setSourcePath(f), b(e);
              }) : b(new d.Path(a.path, a));
            }, d.Path.ATTRIBUTE_NAMES = d.SHARED_ATTRIBUTES.concat(["d"]), d.Path.fromElement = function(a, b, c) {
              var e = d.parseAttributes(a, d.Path.ATTRIBUTE_NAMES);
              b && b(new d.Path(e.d, g(e, c)));
            }, void(d.Path.async = !0));
          }("undefined" != typeof exports ? exports : this), function(a) {
            "use strict";
            var b = a.fabric || (a.fabric = {}),
              ...
              b.Group = b.util.createClass(b.Object, b.Collection, {
                ...
                _calcBounds: function(a) {
                  for (var b,
                      ...
                      e = 0,
                      f = this._objects.length; f > e; ++e) {
                    b = this._objects[e], b.setCoords();
                    for (var g in b.oCoords)
                      c.push(b.oCoords[g].x), d.push(b.oCoords[g].y);
                  }
                  this.set(this._getBounds(c, d, a));
                },
              ...
              applyFilters: function(a) {
                if (this._originalElement) {
                  ...
                  return c.width = b.width, c.height = b.height, c.getContext("2d").drawImage(b, 0, 0, b.width, b.height), this.filters.forEach(function(a) {
                    a && a.applyTo(c);
                  }), d.width = b.width, d.height = b.height, fabric.isLikelyNode ? (d.src = c.toBuffer(void 0, fabric.Image.pngCompression), e._element = d, a && a()) : (d.onload = function() {
            ...
            b.Image.filters.Grayscale = b.util.createClass(b.Image.filters.BaseFilter, {
              ...
              applyTo: function(a) {
                for (var b,
                    ...
                    g = 0; f > g; )
                  b = (e[g] + e[g + 1] + e[g + 2]) / 3, e[g] = b, e[g + 1] = b, e[g + 2] = b, g += 4;
            ...
            b.Image.filters.Invert = b.util.createClass(b.Image.filters.BaseFilter, {
              ...
              applyTo: function(a) {
                var b,
                    ...
                    f = e.length;
                for (b = 0; f > b; b += 4)
                  e[b] = 255 - e[b], e[b + 1] = 255 - e[b + 1], e[b + 2] = 255 - e[b + 2];
                c.putImageData(d, 0, 0);
              }
            ...
            b.Image.filters.Noise = b.util.createClass(b.Image.filters.BaseFilter, {
              ...
              applyTo: function(a) {
                for (var b,
                    ...
                    g = 0,
                    h = e.length; h > g; g += 4)
                  b = (.5 - Math.random()) * f, e[g] += b, e[g + 1] += b, e[g + 2] += b;
                c.putImageData(d, 0, 0);
              },
              toObject: function() {
              ...
              applyTo: function(a) {
                ...
                for (c = 0; l > c; c += this.blocksize)
                  for (d = 0; m > d; d += this.blocksize) {
                    ...
                    for (var n = c,
                        o = c + this.blocksize; o > n; n++)
                      for (var p = d,
                          q = d + this.blocksize; q > p; p++)
                        b = 4 * n * m + 4 * p, k[b] = e, k[b + 1] = f, k[b + 2] = g, k[b + 3] = h;
                  }
            ...
            b.Image.filters.RemoveWhite = b.util.createClass(b.Image.filters.BaseFilter, {
              ...
              applyTo: function(a) {
                for (var b,
                    ...
                    l = 0,
                    m = g.length; m > l; l += 4)
                  b = g[l], c = g[l + 1], d = g[l + 2], b > j && c > j && d > j && k(b - c) < i && k(b - d) < i && k(c - d) < i && (g[l + 3] = 1);
            ...
            b.Image.filters.Sepia = b.util.createClass(b.Image.filters.BaseFilter, {
              ...
              applyTo: function(a) {
                var b,
                    ...
                    g = f.length;
                for (b = 0; g > b; b += 4)
                  c = .3 * f[b] + .59 * f[b + 1] + .11 * f[b + 2], f[b] = c + 100, f[b + 1] = c + 50, f[b + 2] = c + 255;
                d.putImageData(e, 0, 0);
              }
            ...
            b.Image.filters.Sepia2 = b.util.createClass(b.Image.filters.BaseFilter, {
              ...
              applyTo: function(a) {
                var b,
                    ...
                    i = h.length;
                for (b = 0; i > b; b += 4)
                  c = h[b], d = h[b + 1], e = h[b + 2], h[b] = (.393 * c + .769 * d + .189 * e) / 1.351, h[b + 1] = (.349 * c + .686 * d + .168 * e) / 1.203, h[b + 2] = (.272 * c + .534 * d + .131 * e) / 2.14;
            ...
            b.Image.filters.Tint = b.util.createClass(b.Image.filters.BaseFilter, {
              ...
              applyTo: function(a) {
                var c,
                    ...
                    n = m.data,
                    o = n.length;
                for (k = new b.Color(this.color).getSource(), d = k[0] * this.opacity, e = k[1] * this.opacity, f = k[2] * this.opacity, j = 1 - this.opacity, c = 0; o > c; c += 4)
                  g = n[c], h = n[c + 1], i = n[c + 2], n[c] = d + g * j, n[c + 1] = e + h * j, n[c + 2] = f + i * j;
            ...
            b.Image.filters.Multiply = b.util.createClass(b.Image.filters.BaseFilter, {
              ...
              applyTo: function(a) {
                var c,
                    ...
                    g = f.data,
                    h = g.length;
                for (d = new b.Color(this.color).getSource(), c = 0; h > c; c += 4)
                  g[c] *= d[0] / 255, g[c + 1] *= d[1] / 255, g[c + 2] *= d[2] / 255;
                e.putImageData(f, 0, 0);
              },
              toObject: function() {
            ...
            b.Image.filters.Blend = b.util.createClass({
              ...
              applyTo: function(a) {
                var c,
                    ...
                    i,
                    j = a.getContext("2d"),
                    k = j.getImageData(0, 0, a.width, a.height),
                    l = k.data,
                    m = !1;
                if (this.image) {
                  m = !0;
                  ...
                  i = p.getImageData(0, 0, o.width, o.height).data;
                } else
                  i = new b.Color(this.color).getSource(), c = i[0] * this.alpha, d = i[1] * this.alpha, e = i[2] * this.alpha;
                for (var q = 0,
                    r = l.length; r > q; q += 4)
                  switch (f = l[q], g = l[q + 1], h = l[q + 2], m && (c = i[q] * this.alpha, d = i[q + 1] * this.alpha, e = i[q + 2] * this.alpha), this.mode) {
                    case "multiply":
                      l[q] = f * c / 255, l[q + 1] = g * d / 255, l[q + 2] = h * e / 255;
                      break;
                    case "screen":
                      l[q] = 1 - (1 - f) * (1 - c), l[q + 1] = 1 - (1 - g) * (1 - d), l[q + 2] = 1 - (1 - h) * (1 - e);
                      break;
                    case "add":
                      l[q] = Math.min(255, f + c), l[q + 1] = Math.min(255, g + d), l[q + 2] = Math.min(255, h + e);
                      break;
                    case "diff":
                    case "difference":
                      l[q] = Math.abs(f - c), l[q + 1] = Math.abs(g - d), l[q + 2] = Math.abs(h - e);
                      break;
                    case "subtract":
                      var s = f - c,
                          t = g - d,
                          u = h - e;
                      l[q] = 0 > s ? 0 : s, l[q + 1] = 0 > t ? 0 : t, l[q + 2] = 0 > u ? 0 : u;
                      break;
                    case "darken":
                      l[q] = Math.min(f, c), l[q + 1] = Math.min(g, d), l[q + 2] = Math.min(h, e);
                      break;
                    case "lighten":
                      l[q] = Math.max(f, c), l[q + 1] = Math.max(g, d), l[q + 2] = Math.max(h, e);
                  }
            ...
            g.push("fontFamily", "fontWeight", "fontSize", "text", "textDecoration", "textAlign", "fontStyle", "lineHeight", "textBackgroundColor", "useNative", "path"), b.Text = b.util.createClass(b.Object, {
              ...
              _getTextWidth: function(a, b) {
                for (var c = a.measureText(b[0] || "|").width,
                    d = 1,
                    e = b.length; e > d; d++) {
              ...
              _renderTextDecoration: function(a, b) {
                function c(c) {
                  for (var f = 0,
                    ...
                    a.fillRect(e._getLeftOffset() + i, ~~(c + f * e._getHeightOfLine(a, f, b) - d), h, 1);
                  }
                }
                if (this.textDecoration) {
                  var d = this._getTextHeight(a, b) / 2,
                      e = this;
                  this.textDecoration.indexOf("underline") > -1 && c(this.fontSize * this.lineHeight), this.textDecoration.indexOf("line-through") > -1 && c(this.fontSize * this.lineHeight - this.fontSize / 2), this.textDecoration.indexOf("overline") > -1 && c(this.fontSize * this.lineHeight - this.fontSize);
                }
              },
              ...
              _getSVGShadows: function(a, c) {
                ...
                for (d = 0, f = c.length; f > d; d++)
                  if ("" !== c[d]) {
                    var i = this._boundaries && this._boundaries[d] ? this._boundaries[d].left : 0;
                    g.push('<tspan x="', e(i + h + this.shadow.offsetX, 2), 0 === d || this.useNative ? '" y' : '" dy', '="', e(this.useNative ? a * d - this.height / 2 + this.shadow.offsetY : a + (0 === d ? this.shadow.offsetY : 0), 2), '" ', this._getFillAttributes(this.shadow.color), ">", b.util.string.escapeXml(c[d]), "</tspan>"), h = 1;
                  } else
                    h++;
                return g;
              },
              _getSVGTextAndBg: function(a, b, c) {
                ...
                for (var g = 0,
                    h = c.length; h > g; g++)
                  "" !== c[g] ? (this._setSVGTextLineText(c[g], g, d, a, f, e), f = 1) : f++, this.textBackgroundColor && this._boundaries && this._setSVGTextLineBg(e, g, b, a);
                return {
                  textSpans: d,
                  textBgRects: e
                };
