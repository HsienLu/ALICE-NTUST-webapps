  ...
  module.exports = function(grunt) {
    ...
    grunt.initConfig({
      ...
      shell: {
        ...
        npm: {command: 'npm publish'},
        deployExample: {command: function() {
            var retStr = '',
                fs = require('fs');
