				...
				<div class="panelContent">
					...
					<div class="sectionContent">
						<ol>
							...
							<img class="teach" src="/portal/themes/default/images/gettingstarted_static/01.jpg" width="600" />
							<li><spring:message code="pages.gettingstarted.registration_selectTeacher" /></li>
							<img class="teach" src="/portal/themes/default/images/gettingstarted_static/02.jpg" width="600" />
							<li><spring:message code="pages.gettingstarted.registration_fillForm" /></li>
							<img class="teach" src="/portal/themes/default/images/gettingstarted_static/03.jpg" width="600" />
					...
					<div class="sectionContent">
						<ol>
							...
							<img class="teach" src="/portal/themes/default/images/gettingstarted_static/04.jpg" width="600" />
							<li><spring:message code="pages.gettingstarted.run_browseLibrary" arguments="${empty contextPath ? ' ' : contextPath}" /></li>
							<img class="teach" src="/portal/themes/default/images/gettingstarted_static/05.jpg" width="600" />
							<li><spring:message code="pages.gettingstarted.run_select" /></li>
							<img class="teach" src="/portal/themes/default/images/gettingstarted_static/06.jpg" width="600" />
							<li><spring:message code="pages.gettingstarted.run_confirm" /></li>
							<img class="teach" src="/portal/themes/default/images/gettingstarted_static/07.jpg" width="600" />
							<li><spring:message code="pages.gettingstarted.run_archive" /></li>
							<img class="teach" src="/portal/themes/default/images/gettingstarted_static/08.jpg" width="600" />
							<li><spring:message code="pages.gettingstarted.run_periods" /></li>
							<img class="teach" src="/portal/themes/default/images/gettingstarted_static/09.jpg" width="600" />
							<li><spring:message code="pages.gettingstarted.run_configure" /></li>
							<img class="teach" src="/portal/themes/default/images/gettingstarted_static/10.jpg" width="600" />
							<li><spring:message code="pages.gettingstarted.run_preview" /></li>
							<img class="teach" src="/portal/themes/default/images/gettingstarted_static/11.jpg" width="600" />
							<li><spring:message code="pages.gettingstarted.run_created" arguments="${empty contextPath ? ' ' : contextPath}" /></li>
							<img class="teach" src="/portal/themes/default/images/gettingstarted_static/12.jpg" width="600" />
							<li><spring:message code="pages.gettingstarted.run_accessCode" /></li>
							<img class="teach" src="/portal/themes/default/images/gettingstarted_static/13.jpg" width="600" />
						</ol>
					</div>
					...
					<div class="sectionContent">
						<ol>
							...
							<img class="teach" src="/portal/themes/default/images/gettingstarted_static/S11.jpg" width="600" />
							<li><spring:message code="pages.gettingstarted.student_fillForm" /></li>
							<img class="teach" src="/portal/themes/default/images/gettingstarted_static/S12.jpg" width="600" />
							<li><spring:message code="pages.gettingstarted.student_username" /></li>
							<img class="teach" src="/portal/themes/default/images/gettingstarted_static/S13.jpg" width="600" />
							<li><spring:message code="pages.gettingstarted.student_accessCodes" /></li>
							<img class="teach" src="/portal/themes/default/images/gettingstarted_static/S14.jpg" width="600" />
							<li><spring:message code="pages.gettingstarted.student_signIn" /></li>
							<img class="teach" src="/portal/themes/default/images/gettingstarted_static/S15.jpg" width="600" />
							<li><spring:message code="pages.gettingstarted.student_explore" /></li>
							<img class="teach" src="/portal/themes/default/images/gettingstarted_static/S16.jpg" width="600" />
							</ol>
					</div>
