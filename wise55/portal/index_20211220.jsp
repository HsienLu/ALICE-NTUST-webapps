	...
	<div id="page">
		...
		<div id="pageContent">
			...
			<div class="showcase">
				...
				<div id="features">
					...
					<div id="featuresContent">
						...
						<p><!--<a href="pages/gettingstarted.html">--><a href="http://cwiselab.gise.ntnu.edu.tw/cwise_gettingstarted/" target="_blank"><spring:message code="index.features_gettingStarted" /></a></p>
			...
			<div id="bottomLinks" class="showcase">
				<div id="telsLink"><a href="https://wise-research.berkeley.edu/" target="_blank"><img src="${contextPath}/<spring:theme code="tels"/>"/></a></div>
